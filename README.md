...
This is a Flutter app that fetches and displays wallpapers using the [Wallhaven API](https://wallhaven.cc/help/api). Users can browse, search, and view high-resolution wallpapers within the app.
...
flutter_wallpaper_app/ ├── lib/ │ ├── main.dart # App entry point │ ├── api_service.dart # API service to fetch wallpapers │ ├── models/ # Models for parsing API responses │ ├── screens/ # UI screens for different app pages │ └── widgets/ # Custom widgets used across the app ├── .env # Environment variables (not tracked by Git) ├── .gitignore # Git ignore file to exclude sensitive data ├── pubspec.yaml # Flutter dependencies └── README.md # This file
